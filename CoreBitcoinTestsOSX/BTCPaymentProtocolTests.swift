...
class BTCPaymentProtocolTests: XCTestCase {
    ...
    func testOpenAssetsPaymentRequestDetails() {
        ...
        let pr: BTCPaymentDetails = BTCPaymentDetails(data: BTCDataFromHex(""))!
        ...
        let in1: BTCTransactionInput = pr.inputs[0] as! BTCTransactionInput
        let out1: BTCTransactionOutput = pr.outputs[0] as! BTCTransactionOutput
        let out2: BTCTransactionOutput = pr.outputs[1] as! BTCTransactionOutput
        ...
        XCTAssertEqual(pr.outputs.map { (output) -> String in (output as! BTCTransactionOutput).script!.standardAddress.string },
                       ["3JkVptF3n9VS6FGR6NjrEr8NnUCh4TPvMs", "35JBxSyefxmVj34obKC2od3r98MuaJ34am"], "Outputs should have P2SH addresses")
